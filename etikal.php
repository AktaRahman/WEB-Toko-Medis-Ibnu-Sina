						...
						<div class="col-lg-12">
							...
							<ul class="main-nav">
								...
								<li>
													...
													<a href="keluar_user.php">KELUAR</a></li>								
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="row align-items-center">  
			<div class="col-9 col-md-10">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="index_user.php">Produk</a></li><li class="breadcrumb-item active" aria-current="page">Etikal</li>					
...
<p><strong><img alt="" src="img/etikal.jpg" style="width: 800px; height: 600px; margin-left: 10px; margin-right: 10px; float: left;" /></strong></p>

<p><strong>Etikal</strong></p>

<p>Obat etikal adalah obat yang harus diperoleh dengan resep dokter dan hanya bisa dibeli di apotek¹³. Obat etikal dikenal dengan logo lingkaran berwarna merah dan bergaris tepi hitam dengan tulisan K warna hitam di dalam lingkaran warna merah tersebut¹³. Obat etikal hanya boleh digunakan dengan resep dokter dan penggunaannya berada dalam pengawasan yang ketat dari Badan POM¹. Obat etikal terdiri dari obat keras, psikotropika dan narkotika³. Obat keras adalah obat yang hanya dapat dibeli di apotek dengan resep dokter.
</p>
