				...
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
                                <a href="proses-hapus.php?ida=<?php echo $row['id_admin'] ?>" onclick="return confirm('Yakin ingin hapus?')"type="button" class="btn btn-success btn-sm"style="background-color: red;">Hapus</a>
							</td>
						</tr>
						<?php }}else{ ?>
							<tr>
