...
<section class="section-panel menu-nav-inside-alt small">
	...
	<div class="container">
		<ul class="nav nav-pills">
			<li class="nav-item"><a href="generik-1">Otc & Herbal</a></li><li class="nav-item"><a href="otc-dan-herbal">OTC & Herbal</a></li><li class="nav-item"><a href="etikal">Etikal</a></li><li class="nav-item"><a href="kosmetik">Kosmetik</a></li>		</ul>
	</div>
</section>
		...
		<div class="row align-items-center">  
			<div class="col-9 col-md-10">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="index_user.php">Produk</a></li><li class="breadcrumb-item active" aria-current="page">Generik</li>					
...
<p><strong><img alt="" src="img/herbal.jpg" style="width: 800px; height: 600px; margin-left: 10px; margin-right: 10px; float: left;" /></strong></p>

<p><strong>OTC & HERBAL</strong></p>

<p>OTC adalah obat yang dapat dibeli bebas di apotek, sedangkan herbal adalah obat yang terbuat dari bahan-bahan alami. OTC umumnya aman dan efektif untuk mengobati penyakit atau kondisi ringan, sedangkan herbal dapat memiliki efek samping dan tingkat efektivitas yang berbeda-beda.</p>
