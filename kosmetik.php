							...
							<ul class="main-nav">
								...
								<li>
													...
													<a href="">PRODUK</a><ul class="level1-nav"><li>
																	<a href="">Generik</a></li><li>
																	<a href="">OTC & Herbal</a></li><li>
																	<a href="">Etikal</a></li><li>
																	<a href="">Kosmetik</a></li></ul></li><li>
													...
													<a href="history_pembelian.php">RIWAYAT</a><ul class="level1-nav"><li>
																	</ul></li><li>
	...
	<div class="just-padding">
		...
		<li class="list-group-item">
			...
			<a href="">PRODUK</a><ul class="level1-nav"><li>
							...
							<a href="kosmetik">Kosmetik</a></li></ul></li><li>
...
<section class="section-panel menu-nav-inside-alt small">
	...
	<div class="container">
		<ul class="nav nav-pills">
			<li class="nav-item"><a href="generik-1">Generik</a></li><li class="nav-item"><a href="otc-dan-herbal">OTC & Herbal</a></li><li class="nav-item"><a href="etikal">Etikal</a></li><li class="nav-item"><a href="kosmetik">Kosmetik</a></li>		</ul>
	</div>
</section>
		...
		<div class="row align-items-center">  
			<div class="col-9 col-md-10">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="index_user.php">Produk</a></li><li class="breadcrumb-item active" aria-current="page">Kosmetik</li>					
...
<p><strong><img alt="" src="img/kosmetik.jpg" style="width: 800px; height: 600px; margin-left: 10px; margin-right: 10px; float: left;" /></strong></p>

<p><strong>KOSMETIK</strong></p>

<p>Kosmetik adalah produk perawatan yang digunakan untuk meningkatkan penampilan atau aroma tubuh manusia⁴. Menurut Kamus Besar Bahasa Indonesia (KBBI), kosmetik adalah obat (bahan) untuk mempercantik wajah, kulit, rambut dan sebagainya (seperti bedak, pemerah bibir)¹. Kosmetik umumnya merupakan campuran dari beragam senyawa kimia, beberapa terbuat dari sumber-sumber alami dan kebanyakan dari bahan sintetis¹⁴. Tujuannya untuk membersihkan, mewangikan, mengubah penampilan atau memperbaiki bau badan atau melindungi dan memelihara tubuh pada kondisi baik³. Produk kosmetik pun bukan lagi sebuah barang langka, terlebih adanya kosmetik online shop yang menjamur.</p>
