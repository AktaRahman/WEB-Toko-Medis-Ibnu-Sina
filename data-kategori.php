...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <a href="tambah-kategori.php" type="button" class="btn btn-primary mb-3" style="background-color:  #00BFFF;">
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="edit-kategori.php?id=<?php echo $row['id_category'] ?>" type="button" class="btn btn-success btn-sm" style="background-color: lime;">Edit</a>
                                <a href= "proses-hapus.php?idk=<?php echo $row['id_category'] ?>" onclick="return confirm('Ingin hapus data ini?')" type="button" class="btn btn-success btn-sm"style="background-color: red;">Hapus</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
